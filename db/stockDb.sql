...
CREATE TABLE public.portfolio (
    ...
    proift double precision NOT NULL
);
...
COPY public.portfolio (id, symbol, date, "buyPrice", shares, "currentPrice", "currentValue", proift) FROM stdin;
\.
...
COPY public.trans (id, date, symbol, price, shares, total, "isStock") FROM stdin;
\.
